...
public class ClassicPieceStartingPositionPlacer implements PiecePlacer {
    ...
    public void place(Board board) {
        ...
        place(board, WHITE, King.class, "E", 1);
        place(board, WHITE, Bishop.class, "F", 1);
        place(board, WHITE, Knight.class, "G", 1);
        place(board, WHITE, Rook.class, "H", 1);

        place(board, WHITE, Pawn.class, "A", 2);
        place(board, WHITE, Pawn.class, "B", 2);
        place(board, WHITE, Pawn.class, "C", 2);
        place(board, WHITE, Pawn.class, "D", 2);
        place(board, WHITE, Pawn.class, "E", 2);
        place(board, WHITE, Pawn.class, "F", 2);
        place(board, WHITE, Pawn.class, "G", 2);
        place(board, WHITE, Pawn.class, "H", 2);

        place(board, BLACK, Pawn.class, "A", 7);
        place(board, BLACK, Pawn.class, "B", 7);
        place(board, BLACK, Pawn.class, "C", 7);
        place(board, BLACK, Pawn.class, "D", 7);
        place(board, BLACK, Pawn.class, "E", 7);
        place(board, BLACK, Pawn.class, "F", 7);
        place(board, BLACK, Pawn.class, "G", 7);
        place(board, BLACK, Pawn.class, "H", 7);
        ...
        place(board, BLACK, King.class, "E", 8);
